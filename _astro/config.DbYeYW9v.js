...
`,e-1))}function wi(n,e,i){var l,r,u,o,a,c,f,p,t=n.kind,h=n.result,d;if(d=n.input.charCodeAt(n.position),S(d)||D(d)||d===35||d===38||d===42||d===33||d===124||d===62||d===39||d===34||d===37||d===64||d===96||(d===63||d===45)&&(r=n.input.charCodeAt(n.position+1),S(r)||i&&D(r)))return!1;for(n.kind="scalar",n.result="",u=o=n.position,a=!1;d!==0;){if(d===58){if(r=n.input.charCodeAt(n.position+1),S(r)||i&&D(r))break}else if(d===35){if(l=n.input.charCodeAt(n.position-1),S(l))break}else{if(n.position===n.lineStart&&Q(n)||i&&D(d))break;if(F(d))if(c=n.line,f=n.lineStart,p=n.lineIndent,y(n,!1,-1),n.lineIndent>=e){a=!0,d=n.input.charCodeAt(n.position);continue}else{n.position=o,n.line=c,n.lineStart=f,n.lineIndent=p;break}}a&&(I(n,u,o,!1),an(n,n.line-c),u=o=n.position,a=!1),L(d)||(o=n.position+1),d=n.input.charCodeAt(++n.position)}return I(n,u,o,!1),n.result?!0:(n.kind=t,n.result=h,!1)}function _i(n,e){var i,l,r;if(i=n.input.charCodeAt(n.position),i!==39)return!1;for(n.kind="scalar",n.result="",n.position++,l=r=n.position;(i=n.input.charCodeAt(n.position))!==0;)if(i===39)if(I(n,l,n.position,!0),i=n.input.charCodeAt(++n.position),i===39)l=n.position,n.position++,r=n.position;else return!0;else F(i)?(I(n,l,r,!0),an(n,y(n,!1,e)),l=r=n.position):n.position===n.lineStart&&Q(n)?s(n,"unexpected end of the document within a single quoted scalar"):(n.position++,r=n.position);s(n,"unexpected end of the stream within a single quoted scalar")}function Si(n,e){var i,l,r,u,o,a;if(a=n.input.charCodeAt(n.position),a!==34)return!1;for(n.kind="scalar",n.result="",n.position++,i=l=n.position;(a=n.input.charCodeAt(n.position))!==0;){if(a===34)return I(n,i,n.position,!0),n.position++,!0;if(a===92){if(I(n,i,n.position,!0),a=n.input.charCodeAt(++n.position),F(a))y(n,!1,e);else if(a<256&&Vn[a])n.result+=Xn[a],n.position++;else if((o=vi(a))>0){for(r=o,u=0;r>0;r--)a=n.input.charCodeAt(++n.position),(o=Ai(a))>=0?u=(u<<4)+o:s(n,"expected hexadecimal character");n.result+=bi(u),n.position++}else s(n,"unknown escape sequence");i=l=n.position}else F(a)?(I(n,i,l,!0),an(n,y(n,!1,e)),i=l=n.position):n.position===n.lineStart&&Q(n)?s(n,"unexpected end of the document within a double quoted scalar"):(n.position++,l=n.position)}s(n,"unexpected end of the stream within a double quoted scalar")}function Ei(n,e){var i=!0,l,r,u,o=n.tag,a,c=n.anchor,f,p,t,h,d,m=Object.create(null),x,A,E,g;if(g=n.input.charCodeAt(n.position),g===91)p=93,d=!1,a=[];else if(g===123)p=125,d=!0,a={};else return!1;for(n.anchor!==null&&(n.anchorMap[n.anchor]=a),g=n.input.charCodeAt(++n.position);g!==0;){if(y(n,!0,e),g=n.input.charCodeAt(n.position),g===p)return n.position++,n.tag=o,n.anchor=c,n.kind=d?"mapping":"sequence",n.result=a,!0;i?g===44&&s(n,"expected the node content, but found ','"):s(n,"missed comma between flow collection entries"),A=x=E=null,t=h=!1,g===63&&(f=n.input.charCodeAt(n.position+1),S(f)&&(t=h=!0,n.position++,y(n,!0,e))),l=n.line,r=n.lineStart,u=n.position,B(n,e,K,!1,!0),A=n.tag,x=n.result,y(n,!0,e),g=n.input.charCodeAt(n.position),(h||n.line===l)&&g===58&&(t=!0,g=n.input.charCodeAt(++n.position),y(n,!0,e),B(n,e,K,!1,!0),E=n.result),d?R(n,a,m,A,x,E,l,r,u):t?a.push(R(n,null,m,A,x,E,l,r,u)):a.push(x),y(n,!0,e),g=n.input.charCodeAt(n.position),g===44?(i=!0,g=n.input.charCodeAt(++n.position)):i=!1}s(n,"unexpected end of the stream within a flow collection")}function Ti(n,e){var i,l,r=V,u=!1,o=!1,a=e,c=0,f=!1,p,t;if(t=n.input.charCodeAt(n.position),t===124)l=!1;else if(t===62)l=!0;else return!1;for(n.kind="scalar",n.result="";t!==0;)if(t=n.input.charCodeAt(++n.position),t===43||t===45)V===r?r=t===43?pn:di:s(n,"repeat of a chomping mode identifier");else if((p=yi(t))>=0)p===0?s(n,"bad explicit indentation width of a block scalar; it cannot be less than one"):o?s(n,"repeat of an indentation width identifier"):(a=e+p-1,o=!0);else break;if(L(t)){do t=n.input.charCodeAt(++n.position);while(L(t));if(t===35)do t=n.input.charCodeAt(++n.position);while(!F(t)&&t!==0)}for(;t!==0;){for(un(n),n.lineIndent=0,t=n.input.charCodeAt(n.position);(!o||n.lineIndent<a)&&t===32;)n.lineIndent++,t=n.input.charCodeAt(++n.position);if(!o&&n.lineIndent>a&&(a=n.lineIndent),F(t)){c++;continue}if(n.lineIndent<a){r===pn?n.result+=b.repeat(`
